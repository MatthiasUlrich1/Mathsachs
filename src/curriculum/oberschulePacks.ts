    ...
    grade(
      ...
      [
        area('lb1', 'Natürliche Zahlen', 34, [
          ...
          topic('os-k5-lb1-multiplikation', 'Multiplizieren natürlicher Zahlen', 'Zerlege den zweiten Faktor nach Stellenwerten von links; trage Teilprodukte und Summe ein.', ['Multiplikation']),
          topic('os-k5-lb1-division', 'Schriftliche Division durch einstelligen Divisor', 'Trage den Quotienten ziffernweise ein; bei Rest zusätzlich die Rest-Zeile.', ['Division']),
