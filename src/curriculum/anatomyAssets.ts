...
/** Schemas verschiedener Gebisstypen (Original, CC0) — Bild+Blöcke. */
export const GEBISS_FLEISCHFRESSER_ASSET: AnatomyAsset = {
  id: 'gebiss-fleischfresser',
  imageSrc: '/anatomy/gebiss-fleischfresser.svg',
  imageAlt: 'Schema Fleischfresser-Gebiss mit nummerierten Feldern',
  attribution:
    'TaskTrophy / Mathsachs: Originales Unterrichtsschema „Fleischfresser-Gebiss (unbeschriftet)“ — Public Domain (CC0) für Bildungszwecke.',
  drawLeaders: false,
  fachwissenQuelle: 'Wikipedia: Reißzahn',
  fachwissenUrl: 'https://de.wikipedia.org/wiki/Rei%C3%9Fzahn',
  distractors: ['Federkiel', 'Kiemenreusen'],
  slots: [
    {
      id: 'schneide-klein',
      x: 47.6,
      ...
      targetY: 38,
      label: 'Schneidezähne',
      functionDe: 'Abbeißen / Abschneiden',
      wissen: 'Vorn liegen oft kleinere Schneidezähne.',
      concept: 'bio:k5:saeuger:gebiss:carn:schneide',
    },
    {
      id: 'eck-lang',
      x: 23.8,
      ...
      label: 'Eckzähne',
      functionDe: 'Festhalten und Zerreißen',
      wissen: 'Lange Eckzähne kennzeichnen viele Fleischfresser.',
      concept: 'bio:k5:saeuger:gebiss:carn:eck',
    },
    {
      id: 'reisszaehne',
      x: 11.9,
      ...
      targetX: 18,
      targetY: 45,
      label: 'Reißzähne / Backenzähne',
      functionDe: 'Fleisch schneiden',
      wissen: 'Scharfe Backenzähne (Carnassial) zerteilen Beute.',
      concept: 'bio:k5:saeuger:gebiss:carn:reiss',
    },
  ],
}

export const GEBISS_PFLANZENFRESSER_ASSET: AnatomyAsset = {
  id: 'gebiss-pflanzenfresser',
  imageSrc: '/anatomy/gebiss-pflanzenfresser.svg',
  imageAlt: 'Schema Pflanzenfresser-Gebiss mit nummerierten Feldern',
  attribution:
    'TaskTrophy / Mathsachs: Originales Unterrichtsschema „Pflanzenfresser-Gebiss (unbeschriftet)“ — Public Domain (CC0) für Bildungszwecke.',
  drawLeaders: false,
  fachwissenQuelle: 'Wikipedia: Pflanzenfresser',
  fachwissenUrl: 'https://de.wikipedia.org/wiki/Pflanzenfresser',
  ...
  slots: [
    {
      ...
      targetY: 40,
      label: 'Schneidezähne',
      functionDe: 'Abreißen von Pflanzen',
      wissen: 'Flache Schneidezähne greifen Gräser und Blätter.',
      concept: 'bio:k5:saeuger:gebiss:herb:schneide',
    },
    {
      id: 'mahlzaehne',
      x: 19,
      ...
      targetX: 22,
      targetY: 42,
      label: 'breite Mahlzähne',
      functionDe: 'Pflanzen zermahlen',
      wissen: 'Große Kauflächen zermahlen Zellulose-reiche Kost.',
      concept: 'bio:k5:saeuger:gebiss:herb:mahl',
    },
    {
      id: 'luecke',
      x: 50,
      ...
      targetX: 50,
      targetY: 50,
      label: 'Zahnlücke (Diastema)',
      functionDe: 'Platz für Zunge / Futter',
      wissen: 'Viele Pflanzenfresser haben eine Lücke zwischen Schneide- und Backenzähnen.',
      concept: 'bio:k5:saeuger:gebiss:herb:luecke',
    },
  ],
}

export const GEBISS_ALLESFRESSER_ASSET: AnatomyAsset = {
  id: 'gebiss-allesfresser',
  imageSrc: '/anatomy/gebiss-allesfresser.svg',
  imageAlt: 'Schema Allesfresser-Gebiss mit nummerierten Feldern',
  attribution:
    'TaskTrophy / Mathsachs: Originales Unterrichtsschema „Allesfresser-Gebiss (unbeschriftet)“ — Public Domain (CC0) für Bildungszwecke.',
  drawLeaders: false,
  fachwissenQuelle: 'Wikipedia: Zahnformel',
  fachwissenUrl: 'https://de.wikipedia.org/wiki/Zahnformel',
  distractors: ['Schwimmblase', 'Federkiel'],
  slots: [
    {
      id: 'incisivi',
      x: 47.6,
      ...
      label: 'Schneidezähne',
      functionDe: 'Abbeißen',
      wissen: 'Schneidezähne stehen vorn zum Abbeißen.',
      concept: 'bio:k5:saeuger:gebiss:omni:schneide',
    },
    {
      id: 'canini',
      x: 31,
      ...
      targetY: 42,
      label: 'Eckzähne',
      functionDe: 'Festhalten / Reißen',
      wissen: 'Mäßig ausgeprägte Eckzähne — Mischkost.',
      concept: 'bio:k5:saeuger:gebiss:omni:eck',
    },
    {
      id: 'praemolaren',
      x: 16.7,
      ...
      targetY: 45,
      label: 'Vorbackenzähne',
      functionDe: 'Zerkleinern',
      wissen: 'Prämolaren zerkleinern unterschiedliche Nahrung.',
      concept: 'bio:k5:saeuger:gebiss:omni:prae',
    },
    {
      id: 'molaren',
      x: 83.3,
      ...
      targetY: 45,
      label: 'Backenzähne',
      functionDe: 'Zermahlen',
      wissen: 'Molaren mahlen pflanzliche und andere Kost.',
      concept: 'bio:k5:saeuger:gebiss:omni:molar',
    },
  ],
}
