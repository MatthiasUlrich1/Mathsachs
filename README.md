...
Aktuelle Version: **0.27.25** · [Changelog](CHANGELOG.md) ·
...
- **Windows-Installer:**
  [Mathsachs-Setup-0.27.25.exe](https://github.com/MatthiasUlrich1/Mathsachs/releases/download/v0.27.25/Mathsachs-Setup-0.27.25.exe)
- **macOS-Installer (Apple Silicon):**
  [Mathsachs-0.27.25-arm64.dmg](https://github.com/MatthiasUlrich1/Mathsachs/releases/download/v0.27.25/Mathsachs-0.27.25-arm64.dmg)
- **Linux (AppImage):**
  [Mathsachs-0.27.25.AppImage](https://github.com/MatthiasUlrich1/Mathsachs/releases/download/v0.27.25/Mathsachs-0.27.25.AppImage)
- **Linux (Debian/Ubuntu):**
  [mathsachs_0.27.25_amd64.deb](https://github.com/MatthiasUlrich1/Mathsachs/releases/download/v0.27.25/mathsachs_0.27.25_amd64.deb)
